...
public class EquipArmor_State : State
{
    public EquipArmor_State(New_Field_Menu system) : base(system)
    {
    }
    ...
    {
        if (_system.Equipment.Container.Items[_system.selectedOption].item.type == ItemType.Armor)
        {
            switch (_system.currentPM)
            {
                case 1:
                    if (GameMaster.P1Armor == null)
                    {
                        ...
                        GameMaster.P1Armor = _system.Equipment.Container.Items[_system.selectedOption].item;
                    }
                    else
                    {
                ...
                case 2:
                    ...
                    {
                        _system.Equipment.RemoveItem(_system.selectedOption, 1);
                        GameMaster.P2Armor = _system.Equipment.Container.Items[_system.selectedOption].item;
                    }
                    else
                    {
